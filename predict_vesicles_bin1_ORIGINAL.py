...
def predict_vesicles(volumen, parent_path, project_dir, shape_bin5, shape_bin1): #parent_path: carpeta con todas las funciones, project_dir: carpeta con volumen, mascara neuronas, mascada mito, etc.
    ...
    tifffile.imsave(r'\Users\ulabceriani\Documents\ITBA\pruebainterfaz\prueba_zt2_100a200slices\predictions_bin1\prob_colors.tif', np.transpose(tiff_prob_colors, axes=(0,2,1)))
    tifffile.imsave(r'\Users\ulabceriani\Documents\ITBA\pruebainterfaz\prueba_zt2_100a200slices\predictions_bin1\center_final.tif', np.transpose(tiff_centers_final , axes=(0,2,1)))
